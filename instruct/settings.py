...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER')  # Ensure you've set this environment variable
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD')  # Ensure you've set this environment variable
